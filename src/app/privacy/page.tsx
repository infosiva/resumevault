...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for ResumeVault — how we collect, use and protect your data.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Who We Are">
        <p>ResumeVault (https://resumevault.app) is operated by an independent developer. AI resume builder — paste a job description and get a tailored CV in seconds.</p>
